...
| v2.1 | 2026-06-30 | 修正全題庫與分類題庫的互斥選取邏輯，避免同時選取全題庫與其他分類。 |
| v2.1 | 2026-06-30 | Sidebar 新增「收藏題目」入口，可查看收藏清單並匯出收藏題目 JSON。 |
| v2.1 | 2026-06-30 | 選擇題首頁改為可捲動，視窗縮小時仍可查看最近刷題紀錄。 |
| v2.1 | 2026-06-30 | 調整首頁顯示：目前題庫文字加粗加大、匯入題庫按鈕移至右側並改為綠色。 |
| v2.1 | 2026-06-30 | 將選擇題首頁的「選擇大題」、「出題與顯示設定」、「選擇範圍」分成不同灰階背景區塊。 |
...
- 作答時可切換上一題與下一題
- 可收藏目前題目
- 可從 Sidebar 查看收藏題目，並匯出收藏題目 JSON
- 交卷後統一檢查答案
...
可從 Sidebar 的「收藏題目」頁查看目前收藏清單，並匯出成 JSON 檔案。
